      ...
      <Card className="p-4">
        <div className="grid gap-3 xl:grid-cols-[1.5fr_repeat(6,1fr)]">
          ...
          <label className="grid gap-1">
            ...
            <input className="focus-ring min-h-11 rounded-lg border border-slate-300 bg-white px-3 text-sm" type="date" value={filters.startDate} onChange={(event) => updateFilter("startDate", event.target.value)} />
          </label>
          <label className="grid gap-1">
            <span className="text-xs font-semibold text-slate-500 xl:sr-only">End date</span>
            <input className="focus-ring min-h-11 rounded-lg border border-slate-300 bg-white px-3 text-sm" type="date" value={filters.endDate} onChange={(event) => updateFilter("endDate", event.target.value)} />
          </label>
